...
class ProcessTransactions(beam.PTransform):
    ...
    def expand(self, pcoll):
        return (
            ...
            | "Extract Transaction" >> beam.ParDo(ExtractTransaction())  # Apply transformation (with the Help of ExtractTransaction class)
            | "Key Pairs" >> beam.Map(lambda x: (x['timestamp'], x['transaction_amount']))  # Key by date and pass amount
